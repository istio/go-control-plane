...
var file_envoy_extensions_filters_network_http_connection_manager_v4alpha_http_connection_manager_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xac, 0x2d, 0x0a, 0x15, 0x48, 0x74, 0x74, 0x70, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63,
	...
	0xbc, 0x01, 0x0a, 0x20, 0x70, 0x61, 0x74, 0x68, 0x5f, 0x77, 0x69, 0x74, 0x68, 0x5f, 0x65, 0x73,
	0x63, 0x61, 0x70, 0x65, 0x64, 0x5f, 0x73, 0x6c, 0x61, 0x73, 0x68, 0x65, 0x73, 0x5f, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x2d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x74, 0x2e, 0x65, 0x6e, 0x76,
	...
	0x64, 0x53, 0x6c, 0x61, 0x73, 0x68, 0x65, 0x73, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x86,
	...
	0x52, 0x44, 0x10, 0x04, 0x3a, 0x58, 0x9a, 0xc5, 0x88, 0x1e, 0x53, 0x0a, 0x51, 0x65, 0x6e, 0x76,
	0x6f, 0x79, 0x2e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x66, 0x69,
	0x6c, 0x74, 0x65, 0x72, 0x73, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x68, 0x74,
	0x74, 0x70, 0x5f, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6d, 0x61,
	...
	0x65, 0x72, 0x22, 0xb8, 0x02, 0x0a, 0x03, 0x52, 0x64, 0x73, 0x12, 0x56, 0x0a, 0x0d, 0x63, 0x6f,
	...
	0x63, 0x65, 0x12, 0x2c, 0x0a, 0x11, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52,
	0x0f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4e, 0x61, 0x6d, 0x65,
	0x12, 0x51, 0x0a, 0x14, 0x72, 0x64, 0x73, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
...
var file_envoy_extensions_filters_network_http_connection_manager_v4alpha_http_connection_manager_proto_depIdxs = []int32{
	...
	15, // 18: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.internal_address_config:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.InternalAddressConfig
	...
	16, // 21: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.set_current_client_cert_details:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.SetCurrentClientCertDetails
	17, // 22: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.upgrade_configs:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.UpgradeConfig
	...
	3,  // 24: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.path_with_escaped_slashes_action:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.PathWithEscapedSlashesAction
	13, // 25: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.request_id_extension:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.RequestIDExtension
	6,  // 26: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.local_reply_config:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.LocalReplyConfig
	...
	7,  // 28: envoy.extensions.filters.network.http_connection_manager.v4alpha.LocalReplyConfig.mappers:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.ResponseMapper
	30, // 29: envoy.extensions.filters.network.http_connection_manager.v4alpha.LocalReplyConfig.body_format:type_name -> envoy.config.core.v4alpha.SubstitutionFormatString
	31, // 30: envoy.extensions.filters.network.http_connection_manager.v4alpha.ResponseMapper.filter:type_name -> envoy.config.accesslog.v4alpha.AccessLogFilter
	27, // 31: envoy.extensions.filters.network.http_connection_manager.v4alpha.ResponseMapper.status_code:type_name -> google.protobuf.UInt32Value
	32, // 32: envoy.extensions.filters.network.http_connection_manager.v4alpha.ResponseMapper.body:type_name -> envoy.config.core.v4alpha.DataSource
	30, // 33: envoy.extensions.filters.network.http_connection_manager.v4alpha.ResponseMapper.body_format_override:type_name -> envoy.config.core.v4alpha.SubstitutionFormatString
	33, // 34: envoy.extensions.filters.network.http_connection_manager.v4alpha.ResponseMapper.headers_to_add:type_name -> envoy.config.core.v4alpha.HeaderValueOption
	34, // 35: envoy.extensions.filters.network.http_connection_manager.v4alpha.Rds.config_source:type_name -> envoy.config.core.v4alpha.ConfigSource
	35, // 36: envoy.extensions.filters.network.http_connection_manager.v4alpha.Rds.rds_resource_locator:type_name -> udpa.core.v1.ResourceLocator
	36, // 37: envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRouteConfigurationsList.scoped_route_configurations:type_name -> envoy.config.route.v4alpha.ScopedRouteConfiguration
	...
	9,  // 40: envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.scoped_route_configurations_list:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRouteConfigurationsList
	11, // 41: envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.scoped_rds:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRds
	...
	37, // 43: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpFilter.typed_config:type_name -> google.protobuf.Any
	38, // 44: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpFilter.config_discovery:type_name -> envoy.config.core.v4alpha.ExtensionConfigSource
	37, // 45: envoy.extensions.filters.network.http_connection_manager.v4alpha.RequestIDExtension.typed_config:type_name -> google.protobuf.Any
	39, // 46: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.Tracing.client_sampling:type_name -> envoy.type.v3.Percent
	39, // 47: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.Tracing.random_sampling:type_name -> envoy.type.v3.Percent
	39, // 48: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.Tracing.overall_sampling:type_name -> envoy.type.v3.Percent
	...
	40, // 50: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.Tracing.custom_tags:type_name -> envoy.type.tracing.v3.CustomTag
	41, // 51: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.Tracing.provider:type_name -> envoy.config.trace.v4alpha.Tracing.Http
	...
	12, // 53: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.UpgradeConfig.filters:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpFilter
	...
	19, // 55: envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.fragments:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder
	20, // 56: envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.header_value_extractor:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor
	21, // 57: envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.element:type_name -> envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement
